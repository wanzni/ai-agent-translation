...
public class PdfFileTranslatorTest {
    ...
    public void testOverlayTranslation_NoGarbledAndSkipNumbers() throws Exception {
        ...
        TranslationService mockService = new TranslationService() {
            ...
            @Override
            public List<cn.net.susan.ai.translation.dto.SupportedLanguageResponse> getSupportedLanguages() { return List.of(); }

            @Override
            public org.springframework.data.domain.Page<cn.net.susan.ai.translation.entity.TranslationRecord> getTranslationHistory(Long userId, org.springframework.data.domain.Pageable pageable) { return org.springframework.data.domain.Page.empty(); }

            @Override
            public cn.net.susan.ai.translation.entity.TranslationRecord getTranslationById(Long id) { return null; }
            ...
            @Override
            public cn.net.susan.ai.translation.dto.TranslationStatisticsResponse getTranslationStatistics(Long userId) { 
                return cn.net.susan.ai.translation.dto.TranslationStatisticsResponse.builder().totalTranslations(0L).build();
            }

            @Override
            public cn.net.susan.ai.translation.dto.TranslationResponse retranslate(Long id, String engine) { 
                return cn.net.susan.ai.translation.dto.TranslationResponse.builder().translatedText("RETRANSLATED").build();
            }
            ...
            @Override
            public org.springframework.data.domain.Page<cn.net.susan.ai.translation.entity.TranslationRecord> searchTranslations(String keyword, Long userId, org.springframework.data.domain.Pageable pageable) {
