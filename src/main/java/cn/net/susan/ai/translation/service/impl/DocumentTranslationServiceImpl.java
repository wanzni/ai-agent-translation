...
import cn.net.susan.ai.translation.entity.QualityAssessment;
import cn.net.susan.ai.translation.enums.*;
import cn.net.susan.ai.translation.repository.DocumentTranslationRepository;
import cn.net.susan.ai.translation.repository.FileStorageRepository;
import cn.net.susan.ai.translation.entity.FileStorage;
import cn.net.susan.ai.translation.repository.PointsTransactionRepository;
import cn.net.susan.ai.translation.entity.PointsTransaction;
import cn.net.susan.ai.translation.repository.QualityAssessmentRepository;
...
import cn.net.susan.ai.translation.util.UserContextUtils;
    ...
    public DocumentTranslation startTranslation(Long id, String engine, String targetLanguage, String translationType) throws Exception {
        ...
        new Thread(() -> {
            try {
                ...
                // 使用工厂选择翻译器
                cn.net.susan.ai.translation.service.file.DocumentFileTranslator translator =
                        cn.net.susan.ai.translation.service.file.DocumentFileTranslatorFactory.forExtension(lowerExt);
