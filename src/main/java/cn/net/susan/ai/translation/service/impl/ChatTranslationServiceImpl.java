...
import cn.net.susan.ai.translation.repository.ChatMessageRepository;
import cn.net.susan.ai.translation.repository.ChatSessionRepository;
...
public class ChatTranslationServiceImpl implements ChatTranslationService {
    ...
    public ChatMessageResponse createAssistantReply(
        ...
        msg.setTranslationStatus(cn.net.susan.ai.translation.enums.TranslationStatusEnum.COMPLETED);
    ...
    private ChatMessage translateMessageSync(ChatMessage message) {
        ...
        // 标记为翻译中
        message.setTranslationStatus(cn.net.susan.ai.translation.enums.TranslationStatusEnum.TRANSLATING);
        message = chatMessageRepository.save(message);
        ...
        message.setTranslationStatus(cn.net.susan.ai.translation.enums.TranslationStatusEnum.COMPLETED);
        message = chatMessageRepository.save(message);
