...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, Long> {
     ...
     * @return 平均翻译时间（毫秒）
     */
    @Query("SELECT AVG(c.translationTime) FROM ChatMessage c WHERE c.translationStatus = cn.net.wanzni.ai.translation.enums.TranslationStatusEnum.COMPLETED")
     ...
     * @return 需要重新翻译的消息列表
     */
    @Query("SELECT cm FROM ChatMessage cm WHERE cm.translationStatus IN (cn.net.wanzni.ai.translation.enums.TranslationStatusEnum.PENDING, cn.net.wanzni.ai.translation.enums.TranslationStatusEnum.TRANSLATING) ORDER BY cm.createdAt ASC")
