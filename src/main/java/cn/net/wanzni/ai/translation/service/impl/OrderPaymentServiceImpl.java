...
import cn.net.wanzni.ai.translation.mq.OrderCancelProducer;
import cn.net.wanzni.ai.translation.enums.PaymentMethodEnum;
import cn.net.wanzni.ai.translation.enums.PaymentProviderEnum;
import cn.net.wanzni.ai.translation.repository.MembershipOrderRepository;
import cn.net.wanzni.ai.translation.repository.PaymentRecordRepository;
import cn.net.wanzni.ai.translation.repository.UserRepository;
import cn.net.wanzni.ai.translation.service.MembershipService;
import cn.net.wanzni.ai.translation.service.PointsService;
import cn.net.wanzni.ai.translation.service.OrderPaymentService;
...
public class OrderPaymentServiceImpl implements OrderPaymentService {
     ...
     * @return 支付记录
     */
    private PaymentRecord createInitiatedRecord(MembershipOrder order, PaymentProviderEnum provider,
                                                PaymentMethodEnum method, String paymentNo) {
     ...
     * @return 支付记录
     */
    private PaymentRecord createSuccessRecordForPay(MembershipOrder order, PaymentProviderEnum provider,
                                                    PaymentMethodEnum method, String paymentNo) {
        return PaymentRecord.builder()
                .orderId(order.getId())
                .paymentNo(paymentNo)
